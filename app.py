...
#алгоритмы и программные средства автоматического контроля и построения расписаний информационной системы отдела планирования

#разделы
#общие сведения + 3 раздела
#сценарий
#визуализация
#расписание
#коллизии
...
#сранительный анализ (обзор) алгоритмов атвоматического составления расписания
